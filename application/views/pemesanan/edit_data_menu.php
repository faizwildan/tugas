      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card-header py-3 border-bottom-warning">
            <form action="<?= base_url() ?>index.php/Pemesanan/insertdata" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="jenis_menu" value="<?= $data->jenis_menu ?>" class="form-control" readonly required>
                </div>
            ...
            <select class="form-control" name="id_kategori" readonly required>
